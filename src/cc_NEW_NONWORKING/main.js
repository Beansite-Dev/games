...
"./"='//cdn.dashnet.org/cookieclicker/';
// if (!App && !Game.local && window.location.href.indexOf('orteil.dashnet.org')!=-1)
// {
// 	"./"=('//'+location.host+location.pathname).replace('orteil.dashnet.org','cdn.dashnet.org');
// 	if ("./".slice(-1)!='/') "./"+='/';
// }
...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(me)
				{
					...
					{
						bgPic="./"+'img/familiars.png';
						picX=Math.floor(Math.random()*4);
						if (me.wrath) picY=1;
					}
					else if (Game.season=='christmas')
					{
						bgPic="./"+'img/goldCookieWreath.png';
						if (me.wrath) bgPic="./"+'img/wrathCookieWreath.png';
					}
		...
		Game.last.descFunc=function(){
			...
			var x=Math.floor(Game.realT);
			return this.desc+'<q>'+loc("Everyone's here.")+'<div id="parade" style="position:absolute;left:-11px;right:-11px;height:32px;background:url('+"./"+'img/parade.png) -'+x+'px '+(x%20<10?0:32)+'px;"></div><div style="margin-bottom:32px;"></div>'+loc("Won't you have some cookies too?")+'</q>';
		};
